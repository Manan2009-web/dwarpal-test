...
const env = {
  ...
  smtpPass: normalizeEnvString(process.env.SMTP_PASS).replace(/\s+/g, ''),
  ...
  smtpFromEmail: (normalizeEnvString(process.env.SMTP_FROM_EMAIL) || legacyEmailFrom.email).toLowerCase(),
  smtpConnectionTimeoutMs: parsePositiveIntegerEnv(process.env.SMTP_CONNECTION_TIMEOUT_MS, 15000),
  smtpGreetingTimeoutMs: parsePositiveIntegerEnv(process.env.SMTP_GREETING_TIMEOUT_MS, 15000),
  smtpSocketTimeoutMs: parsePositiveIntegerEnv(process.env.SMTP_SOCKET_TIMEOUT_MS, 20000),
  smtpOperationTimeoutMs: parsePositiveIntegerEnv(process.env.SMTP_OPERATION_TIMEOUT_MS, 20000),
