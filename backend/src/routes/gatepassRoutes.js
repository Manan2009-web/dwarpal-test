...
router.post('/security/scan', authorize('security', 'campus_security'), scanQrValidation, validateRequest, gatepassController.scanGatepassQr);
router.get('/security/verify-id/:gatepassId', authorize('security', 'campus_security'), verifyGatepassIdValidation, validateRequest, gatepassController.verifyGatepassById);
router.get('/security/verify/:token', authorize('security', 'campus_security'), verifyTokenValidation, validateRequest, gatepassController.verifyGatepassByToken);
