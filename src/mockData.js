export const ROLE_META = {
  ...
  faculty: {
    ...
    panelTitle: 'Professor Dashboard',
  ...
  hod: {
    title: 'Academic HOD',
    shortTitle: 'Academic HOD',
    panelTitle: 'Academic HOD Dashboard',
  ...
  security: {
    ...
    panelTitle: 'Security | Main Gate Dashboard',
  ...
  campus_security: {
    ...
    shortTitle: 'Bouncer',
    panelTitle: 'Security | Bouncer Dashboard',
    accent: 'var(--accent-security)',
    idLabel: 'Employee ID',
  },
}
...
export const initialGatepasses = [
  ...
  },
  {
    ...
    timeline: [
      ...
      { label: 'Forwarded by Principal', note: 'Sent to Academic HOD for final decision', at: '2026-03-18T12:55', tone: 'done' },
