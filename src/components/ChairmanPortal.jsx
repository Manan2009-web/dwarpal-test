  ...
  return (
    <div className="admin-page-stack">
      <section className="admin-wide-panel" style={{ padding: '24px', background: 'var(--app-surface)', borderRadius: '12px', border: '1px solid var(--app-border)', display: 'flex', flexDirection: 'column', gap: '20px' }}>
        ...
        {loading ? (
          <div className="admin-empty-state" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '200px', flexDirection: 'column', gap: '12px', color: 'var(--app-text-muted)' }}>
            <RefreshCw size={24} className="spin" style={{ color: 'var(--app-accent)', animation: 'spin 1s linear infinite' }} />
            <span>Loading gatepass reviews…</span>
          </div>
        ) : cards.length > 0 ? (
