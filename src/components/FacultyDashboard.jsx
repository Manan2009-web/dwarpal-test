...
const FacultyDashboard = ({ user }) => {
  ...
  useEffect(() => {
    ...
    // Filter gatepasses for this faculty
    const userGatepasses = mockGatepasses.filter(gp => gp.facultyId === user.id)
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <DashboardHeaderBranding roleName="Faculty" dashboardTitle="Faculty Dashboard" />
